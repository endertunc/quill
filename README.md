...
Quill is super fast for static queries (almost zero overhead compared to directly sql executing).

But there is significant impact for dynamic queries.

Normalization caching was introduced to improve the situation, which can brings up to 80x times faster for complex queries. It is enabled by default.

To disable dynamic caching, pass following property to sbt during compile time
...
libraryDependencies ++= Seq(
  "io.getquill" %% "quill-spark" % "3.4.103-SNAPSHOT"
)
```
...
libraryDependencies ++= Seq(
  ...
  "io.getquill" %% "quill-jdbc" % "3.4.103-SNAPSHOT"
)
```
...
libraryDependencies ++= Seq(
  "mysql" % "mysql-connector-java" % "8.0.17",
  "io.getquill" %% "quill-jdbc-monix" % "3.4.103-SNAPSHOT"
)
```
...
```
libraryDependencies ++= Seq(
  "io.getquill" %% "quill-async-mysql" % "3.4.103-SNAPSHOT"
)
```
...
```
libraryDependencies ++= Seq(
  "io.getquill" %% "quill-async-postgres" % "3.4.103-SNAPSHOT"
)
```
...
```
libraryDependencies ++= Seq(
  "io.getquill" %% "quill-finagle-mysql" % "3.4.103-SNAPSHOT"
)
```
...
```
libraryDependencies ++= Seq(
  "io.getquill" %% "quill-finagle-postgres" % "3.4.103-SNAPSHOT"
)
```
...
```
libraryDependencies ++= Seq(
  "io.getquill" %% "quill-cassandra" % "3.4.103-SNAPSHOT"
)
```
...
```
libraryDependencies ++= Seq(
  "io.getquill" %% "quill-cassandra-monix" % "3.4.103-SNAPSHOT"
)
```
...
```
libraryDependencies ++= Seq(
  "io.getquill" %% "quill-orientdb" % "3.4.103-SNAPSHOT"
)
```
...
```
libraryDependencies ++= Seq(
  "io.getquill" %% "quill-codegen-jdbc" % "3.4.103-SNAPSHOT"
)
```
