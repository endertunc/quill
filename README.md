...
libraryDependencies ++= Seq(
  "io.getquill" %% "quill-spark" % "3.3.2-SNAPSHOT"
)
```
...
libraryDependencies ++= Seq(
  ...
  "io.getquill" %% "quill-jdbc" % "3.3.2-SNAPSHOT"
)
```
...
libraryDependencies ++= Seq(
  "mysql" % "mysql-connector-java" % "8.0.15",
  "io.getquill" %% "quill-jdbc-monix" % "3.3.2-SNAPSHOT"
)
```
...
```
libraryDependencies ++= Seq(
  "io.getquill" %% "quill-async-mysql" % "3.3.2-SNAPSHOT"
)
```
...
```
libraryDependencies ++= Seq(
  "io.getquill" %% "quill-async-postgres" % "3.3.2-SNAPSHOT"
)
```
...
```
libraryDependencies ++= Seq(
  "io.getquill" %% "quill-finagle-mysql" % "3.3.2-SNAPSHOT"
)
```
...
```
libraryDependencies ++= Seq(
  "io.getquill" %% "quill-finagle-postgres" % "3.3.2-SNAPSHOT"
)
```
...
```
libraryDependencies ++= Seq(
  "io.getquill" %% "quill-cassandra" % "3.3.2-SNAPSHOT"
)
```
...
```
libraryDependencies ++= Seq(
  "io.getquill" %% "quill-cassandra-monix" % "3.3.2-SNAPSHOT"
)
```
...
```
libraryDependencies ++= Seq(
  "io.getquill" %% "quill-orientdb" % "3.3.2-SNAPSHOT"
)
```
...
```
libraryDependencies ++= Seq(
  "io.getquill" %% "quill-codegen-jdbc" % "3.3.2-SNAPSHOT"
)
```
